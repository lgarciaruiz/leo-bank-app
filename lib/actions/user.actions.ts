...
export const exchangePublicTokenProps = async ({
  publicToken,
  user,
  ...
  try {
    ...
    // Create processor token for Dwolla user the access token and account id
    ...
    // create a bank accoutn using the user ID, item ID, account ID, access token, funding source Url, and shareableId
